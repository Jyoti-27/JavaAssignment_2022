...
public class SetDemo1 {
	...
	// Set is used foe unique data(or value) i.e. duplicate data is not allowed in set
	...
	// 1. HashSet==> It doesn't maintain insertion order	
    Set<String> set=new HashSet<>();                    // or  HashSet<String> set=new HashSet<>();
	set.add("Sachin");
	set.add("Sourav");
	set.add("Rahul");
	...
	//Object sample=new HashSet<>.clone();
